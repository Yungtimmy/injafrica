      ...
      {entries.length >= 3 && (
        <div className="sb-card mb-4 p-4">
          <div className="flex items-end justify-center gap-3">
            {/* 2nd */}
            <Link href={`/players/${entries[1].discordId}`} className="flex flex-col items-center gap-1 pb-0 hover:opacity-80">
            ...
            {/* 1st */}
            <Link href={`/players/${entries[0].discordId}`} className="flex flex-col items-center gap-1 -mb-px hover:opacity-80">
            ...
            {/* 3rd */}
            <Link href={`/players/${entries[2].discordId}`} className="flex flex-col items-center gap-1 pb-0 hover:opacity-80">
